<?php
/* setting bot */
$ads=$ijo."    [ official chanel Tuko Van ]".$t.$red."\t >> subcribe chanel << ".$t.$pth."[ ".$ijo."XXX".$pth." ]=[".$kn." Tuko Van ".$pth."]=[ ".$tr."XXX ]".$t;
...
$msg_ice=$ijo."[•]=[info]".$t.
"[-] update lagi icebreaker 13 maret tutor chanel ytb Tuko Van".$t;
...
──── █▀█ █ █─▀▌────".$tr." ─█─ █─█ █▀▄─ █▀▀ █─▀█────".$br."
──── ▀▀─ ▀ ▀▀▀─────".$tr." ─▀─ ─▀─ ▀─▀▀ ▀▀▀ ▀──▀────".$pth."
=| creator : ".$ijo."Tuko Van ".$pth."|==| versi :".$tr." [ 1.0 ]".$pth." |=".$t;
